...
public class String1 {
    ...
    public boolean hasBad(String str) {
        return (str.indexOf("bad") == 0 || str.indexOf("bad") == 1) && str.length() >= 3;
    }
    ...
    public String deFront(String str) {    
        boolean firstChar = str.charAt(0) == 'a';
        boolean secondChar = str.charAt(1) == 'b';

        if(firstChar && secondChar) return str;
        else if(firstChar) return str.substring(0, 1) + str.substring(2);
        else if (secondChar) return str.substring(1);
    ...
    public String startWord(String str, String word) {
        if(word.length() == 0 || str.length() == 0 || str.length() < word.length()) return "";
        else if(word.length() == 1) return str.substring(0,1);
        else if(str.substring(1, word.length()).equals(word.substring(1))) return str.substring(0, word.length());
        return "";
    }
    ...
    public String withoutX(String str) {
        ...
        boolean firstChar = str.charAt(0) == 'x';
        boolean lastChar = str.charAt(str.length() - 1) == 'x';

        if(firstChar && lastChar && str.length() > 1) return str.substring(1, str.length() - 1);
        else if(firstChar) return str.substring(1);
        else if(lastChar) return str.substring(0, str.length() - 1);
        else return str;
    }
