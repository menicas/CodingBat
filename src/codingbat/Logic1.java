...
public class Logic1 {
    ...
    public boolean squirrelPlay(int temp, boolean isSummer) {
        return (temp >= 60 && !isSummer && temp <= 90) || (temp >= 60 && temp <= 100 && isSummer);
    }
    ...
    public boolean answerCell(boolean isMorning, boolean isMom, boolean isAsleep) {
        ...
        else if(!isMom && isMorning) return false;
        else return true;
    }
    ...
    public String fizzString(String str) {
        boolean fCond = str.charAt(0) == 'f';
        boolean bCond = str.charAt(str.length()-1) == 'b';
        if(fCond && bCond) return "FizzBuzz";
        else if(fCond) return "Fizz";
        else if(bCond) return "Buzz";
        else return str;
    }
    ...
    public int blueTicket(int a, int b, int c) {
        ...
        else if(ab >= 10 + ac || ab >= 10 + bc) return 5;
        else return 0;
    }
    ...
    public int sumLimit(int a, int b) {
        ...
        if(sumLength == aLength) return a + b;
        else return a;
    }
}